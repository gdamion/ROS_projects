...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /home/ax/Code/ROS_projects/task2_1/src/package)
  set(package_DEVEL_PREFIX /home/ax/Code/ROS_projects/task2_1/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /home/ax/Code/ROS_projects/task2_1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ax/Code/ROS_projects/task2_1/src/package/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ax/Code/ROS_projects/task2_1/devel/lib;/opt/ros/melodic/lib)
